class BotMessageHandler {
    constructor() {
        ...
        this.botMessages = [
            ...
            "На какой специальности? (Обязытельно выбери из предлагаемого списка)", // 5
            ...
            "А опыт работы?", // 9
            "Какие специальности ты для себя рассматриваешь? (Перечисли через ';') (Обязытельно выбери из предлагаемого списка)", // 10
            "Какие сферы бизнеса ты для себя рассматриваешь? (Перечисли через ';') (Обязытельно выбери из предлагаемого списка)", // 11
            "Какие специальности ты для себя категорически не рассматриваешь? (Перечисли через ';')", // 12
            "Какие сферы бизнеса ты для себя категорически не рассматриваешь? (Перечисли через ';')", // 13
